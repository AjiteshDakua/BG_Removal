...
const Header = () => {
  return (
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 lg:mt-20">
      {/* --------  left side  ------------------ */}
      <div>
        ...
        <p className="my-6 text-[15px] text-gray-500">
          Easily remove image backgrounds in seconds with our free online tool.{" "}
          <br className="max-sm:hidden" /> Upload your image and get a clean,
          professional result instantly.
        </p>
        <div>
